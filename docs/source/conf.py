# -*- coding: utf-8 -*-
#
# mito-email-auth documentation build configuration file, created by
...
htmlhelp_basename = 'mito-email-authdoc'
...
latex_documents = [
  ('index', 'mito-email-auth.tex', u'mito-email-auth Documentation',
...
man_pages = [
    ('index', 'mito-email-auth', u'mito-email-auth Documentation',
...
texinfo_documents = [
  ('index', 'mito-email-auth', u'mito-email-auth Documentation',
   u'Alexander Artemenko', 'mito-email-auth', '',
   'Miscellaneous'),
]
